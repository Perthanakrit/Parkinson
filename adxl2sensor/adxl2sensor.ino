...
float acx1,acy1,acz1,acx2,acy2,acz2;
...
void loop(void)
{
  ...
  acx1 = event1.acceleration.x;
  acy1 = event1.acceleration.y;
  acz1 = event1.acceleration.z;
  acx2 = event2.acceleration.x;
  acy2 = event2.acceleration.y;
  acz2 = event2.acceleration.z;
  Serial.print(acx1);Serial.print("_");
  Serial.print(acy1);Serial.print("_");
  Serial.println(acz1);
